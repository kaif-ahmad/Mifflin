    ...
    return ( 
        <div className="container">
            ...
            <div className="row p-5 mt-5 mb-5 border-top">
                <div className="col fs-5 fw-light">We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company Zerodha, a combination of Zero and "Rodha", the Sanskrit word for barrier.<br /><br />
                ...
                <div className="col fs-5 fw-light">
                    ...
                    And yet, we are always up to something new every day. Catch up on the latest updates on our <a href="" style={{textDecoration:"none"}}>blog</a> or see what the media is saying about us or learn more about our business and product <a href="" style={{textDecoration:"none"}}>philosophies</a>.
                </div>
            </div>
        </div>
    );
