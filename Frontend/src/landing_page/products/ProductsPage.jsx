...
function ProductsPage() {
    return ( 
        <>
            ...
            <h3 className='text-center'>Want to know more about our technology stack? Check out the <a href="" className='text-warning' style={{textDecoration:"none"}}>Mifflin.tech</a> blog.</h3>
            <Universe/>
        </>
    );
}
